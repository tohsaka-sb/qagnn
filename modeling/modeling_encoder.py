...
MODEL_CLASS_TO_NAME = {
    ...
    'albert': ['albert-xxlarge-v2', 'albert-base-v2', 'albert-large-v2', 'albert-xlarge-v2'],
    'lstm': ['lstm'],
}
...
def infer_model_class(model_name):
    ...
    if model_name.startswith('albert'):
        return 'albert'
    if model_name.startswith('bert') or 'pubmedbert' in model_name.lower() or 'sapbert' in model_name.lower():
        return 'bert'
...
class TextEncoder(nn.Module):
    ...
    def __init__(self, model_name, output_token_states=False, from_checkpoint=None, **kwargs):
        super().__init__()
        self.model_type = infer_model_class(model_name)
